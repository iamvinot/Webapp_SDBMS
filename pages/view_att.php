...
<div id="page-wrapper">
	<div class="row">
		<div class="col-lg-12">
			<h3 class="page-header">SIMDROID - View Attendance Details </h3><br/>
		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-6">
							<form role="form" method="post" action="disp_att.php">
								...
								<button type="submit" class="btn btn-large btn-info">View Attendance</button>
